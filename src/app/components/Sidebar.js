...
const Sidebar = ({ onMenuItemClick, activeItem }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', component: 'Dashboard', icon: <FiUsers className="text-blue-500" /> },
    { name: 'Ongoing Patients', component: 'OngoingPatients', icon: <FiUsers className="text-blue-500" /> },
